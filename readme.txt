...
6. If you want to add the function to your theme file(s) then use <code>&lt;?php the_author_meta('twitter'); ?&gt;</code> if it's INSIDE the loop or use <code>&lt;?php the_author_meta('twitter', 1); ?&gt;</code> if it's OUTSIDE the loop. 1 is the user ID. Use one of <code>twitter</code>, <code>facebook</code>, <code>googleplus</code> or <code>sciencecard</code>.
...
= 1.0.3 =
* Added Google+ and ScienceCard, removed several services
